...
class rstdp_synapse_test(unittest.TestCase):
    ...
    def test_synapse(self):
        ...
        inputs, neuronpop, voltmeter, spikedetector = self.set_up_network()
        ...
        weights_after['rstdp'] = get_weights(inputs,'rstdp_synapse',
                                             # 'weight')
                                             'accumulation')
        self.assertEqual(weights_after['stdp'],weights_after['rstdp'])
        ...
        # plt.figure()
        # print weights_after
        self.assertEqual(get_weights(inputs,'rstdp_synapse','weight'),
                         self.epsc)
